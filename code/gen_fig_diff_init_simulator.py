...
axs[0].text(-0.18, 1.1, '(a)', transform=axs[0].transAxes, fontsize=12, verticalalignment='top')
...
axs[0].legend(loc='center right', bbox_to_anchor=(1.0, 0.6), fontsize=12)
axs[0].set_xlabel('$t$')
...
axs[1].semilogy(f[1:int(len(f)/2)], abs(mf_D4[1:int(len(mf_D4)/2)]), marker = 'o', markersize = 4, label = r'$\left| \uparrow \uparrow \downarrow \downarrow \downarrow \downarrow \uparrow \uparrow \right\rangle$')
axs[1].semilogy(f[1:int(len(f)/2)], abs(mf_D2[1:int(len(mf_D2)/2)]), marker = 's',markersize = 4, label = r'$\left| \uparrow \uparrow \uparrow \downarrow \downarrow \uparrow \uparrow \uparrow \right\rangle$')
axs[1].semilogy(f[1:int(len(f)/2)], abs(mf_D0[1:int(len(mf_D0)/2)]), marker = '^',markersize = 4, label = r'$\left| \uparrow \uparrow \uparrow \uparrow \uparrow \uparrow \uparrow \uparrow \right\rangle$')
axs[1].set_ylim(0, 70)
axs[1].legend(loc='best', framealpha=1.0, fontsize=12)
m1 = 1.
m2 = 1.6180339887 * m1
m3 = 1.9890437907 * m1
m4 = 2.4048671724 * m1
axs[1].text(-0.15, 1.1, '(b)', transform=axs[1].transAxes, fontsize=12, verticalalignment='top')
...
axs[1].text(m2-m1-0.62, 20, '$m_2-m_1$', fontsize=10)
